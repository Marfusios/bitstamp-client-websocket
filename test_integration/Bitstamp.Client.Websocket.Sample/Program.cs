...
class Program
{
    ...
    static async Task SendSubscriptionRequests(BitstampWebsocketClient client)
    {
        //client.Send(new SubscribeRequest("btcusd", PublicChannel.OrderBook));
        //client.Send(new SubscribeRequest("btceur", PublicChannel.OrderBook));

        //client.Send(new SubscribeRequest("btcusd", PublicChannel.OrderBookDetail));
        //client.Send(new SubscribeRequest("btceur", PublicChannel.OrderBookDetail));

        //client.Send(new SubscribeRequest("btcusd", PublicChannel.OrderBookDiff));
        //client.Send(new SubscribeRequest("btceur", PublicChannel.OrderBookDiff));

        client.Send(new SubscribeRequest("btcusd", PublicChannel.Ticker));
        client.Send(new SubscribeRequest("btceur", PublicChannel.Ticker));
    }

    static void SubscribeToStreams(BitstampWebsocketClient client)
    {
        ...
        {
            Log.Information($"{x.Data} {x.Data.Id} {x.Data.Price}");
            Log.Information($"{x.Symbol} {x.Channel} {x.Data.Amount}");
        });
